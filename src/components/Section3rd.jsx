      ...
      <div className="row row2 h-100 flex-wrap ">
        <div className=" col-12 col-lg-6 herordleft  h-100  flex flex-wrap">
         ...
         <div className="col-12 col-lg-6 section3rdleftimg p-2">
            <img className='object-cover h-full w-full rounded-xl' src="/src/assets/herosectionimg/one.jpg" alt="" />
          </div>
          <div className="col-12 col-lg-6 h-full d-none d-lg-flex flex-col">
            <div className="col-12   p-2">
              <img className='rounded-xl ' src="/src/assets/herosectionimg/two.jpg" alt="" />
            </div>
            <div className="col-12 p-2">
              <img className='rounded-xl ' src="/src/assets/herosectionimg/three.jpg" alt="" />
            </div>
          </div>
        ...
        <div className="col-12 col-lg-6  herorfright flex justify-end ">
          <div className="">
            ...
            <img className='w-80 mt-5' src="/src\assets\section3rd_rightbg.png" alt="" />
          </div>
        </div>
      </div>
