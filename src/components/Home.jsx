...
function Home() {
  ...
  return (
    ...
    <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
      ...
      <video className='h-full w-full object-cover' loop muted autoPlay src="/src\assets\home video\video1.mp4"></video>
      <div className="row row2 h-full flex-col-reverse flex-lg-col hometextcontent">
        {/* <div className="col-12 col-lg-6 homeLeft flex items-center justify-start">
          <div className=" img">
            <img className='h-full w-full object-cover' src="./src/assets/home.jpg" alt="" />
          </div>
        </div> */}
